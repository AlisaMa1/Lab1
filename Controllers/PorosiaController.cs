...
namespace OnlineBookStoreApp.Controllers
{
	...
	public class PorosiaController : Controller
	{
		...
		public IActionResult Detajet(int porosiaId)
		{
			...
			porosiaViewModel.DetajetEPorosive =
				_konteksti.DetajetEPorosive.Include(x => x.Produkti).Where(x => x.PorosiaId == porosiaId);
		...
		public IActionResult Detajet_Paguaj()
		{
			...
			foreach (DetajetEPorosise porosiDetali in PorosiaViewModel.DetajetEPorosive)
			{
				{
